...
<body onload="createPopulationCards(<?php echo $page . ",'$key'"; ?>);">
    <div class="page">
            ...
            <div class="content-inner">
                ...
                <header class="page-header">
                    <div class="container-fluid">
                        <h2 class="no-margin-bottom">年度人数分布统计</h2>
                    </div>
                </header>

                <!-- 搜索栏 -->
                <section class="d-flex flex-column align-items-center">
                    <h2 class="mb-3">搜索景点的年度人数分布信息</h2>
                    <div class="col-8">
                ...
                <div class="container-fluid">
                    <div class="row justify-content-center">
                        <ul id="pop-pagination1" class="pagination">
                        </ul>
                    </div>
                </div>
                ...
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-12 m-b-30">
                            <div id="population-card-container" class="row">
                ...
                <div class="container-fluid">
                    <div class="row justify-content-center">
                        <ul id="pop-pagination2" class="pagination">
                        </ul>
                    </div>
                </div>
